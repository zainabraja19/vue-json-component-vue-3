import './style.css';
import { defineComponent as O, ref as C, computed as B, resolveComponent as E, openBlock as s, createElementBlock as n, createElementVNode as o, withModifiers as K, createCommentVNode as m, renderSlot as j, createTextVNode as Z, toDisplayString as A, Fragment as D, renderList as H, withDirectives as _, createBlock as P, normalizeStyle as N, vShow as T, normalizeClass as q, withKeys as F } from "vue";
const J = { class: "json-view-item" }, z = { key: 0 }, I = ["aria-expanded", "onClick"], G = { style: { display: "inline-block", "vertical-align": "middle" } }, Q = { key: 0 }, R = {
  ...
  ve
], ye = ["role", "tabindex"], me = { class: "value-key" }, ge = ["v-html"], we = ["innerHTML"], pe = O({
  name: "json-view-item"
  ...
  setup(e, { emit: w }) {
    const t = e, c = C(!1), u = C(t.data.depth < t.maxDepth), S = () => {
      u.value = !u.value;
    }, p = B(
    ...
    }), f = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="blue" viewBox="0 0 256 256"><path d="M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z" opacity="0.2"></path><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm56-88a12,12,0,1,1-12-12A12,12,0,0,1,184,128Zm-44,0a12,12,0,1,1-12-12A12,12,0,0,1,140,128Zm-44,0a12,12,0,1,1-12-12A12,12,0,0,1,96,128Z"></path></svg>', M = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green" viewBox="0 0 256 256"><path d="M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z" opacity="0.2"></path><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm12-88a12,12,0,1,1-12-12A12,12,0,0,1,140,128Zm0-44a12,12,0,1,1-12-12A12,12,0,0,1,140,84Zm0,88a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z"></path></svg>';
    return (a, l) => {
      var g, L, V;
      ...
      return s(), n("div", J, [
        e.data.type === "object" || e.data.type === "array" ? (s(), n("div", z, [
          ...
          (s(!0), n(D, null, H(e.data.children, (y) => _((s(), P(x, {
            key: h(y),
            data: y,
            maxDepth: e.maxDepth,
            ...
            onFilter: l[2] || (l[2] = ($) => a.$emit("filter", $)),
            onSelected: i
        ...
        e.data.type === "value" ? (s(), n("div", {
          ...
          onKeyup: [
            l[5] || (l[5] = F((y) => k(e.data), ["enter"])),
            l[6] || (l[6] = F((y) => k(e.data), ["space"]))
          ],
          ...
          e.use_ellipsis ? (s(), n("span", {
            ...
            j(a.$slots, "dataValue"),
            Z(" " + A(((g = e.data.value) == null ? void 0 : g.length) > p.value ? c.value ? e.data.value : (L = e.data.value) == null ? void 0 : L.slice(0, p.value) : e.data.value) + " ", 1),
            ((V = e.data.value) == null ? void 0 : V.length) > p.value ? (s(), n("span", {
              key: 0,
              onClick: l[3] || (l[3] = (y) => {
                var $;
                return (($ = e.data.value) == null ? void 0 : $.length) > p.value ? c.value = !c.value : "";
              }),
              innerHTML: c.value ? M : f
            }, null, 8, we)) : m("", !0)
          ], 6)) : (s(), n("span", {
            key: 0,
            class: q("showOverflow"),
            "v-html": e.data.value,
            style: N(d(e.data.value))
          }, [
            j(a.$slots, "dataValue"),
...
const be = O({
  ...
  setup(e, { emit: w }) {
    const t = e, c = (r, i, h, d, b) => {
      if (u(i)) {
        let v = [];
        for (let [f, M] of Object.entries(i))
          v.push(
            c(
              f,
              M,
    ...
    }, u = (r) => typeof r == "object" && r !== null && !S(r), S = (r) => Array.isArray(r), p = (r) => {
      w("selected", r);
    }, k = B(() => typeof t.data == "object" ? c(t.rootKey, { ...t.data }, 0, "", !0) : {
      key: t.rootKey,
      type: "value",
      path: "",
      depth: 0,
    ...
    return C(), C(), (r, i) => (s(), P(ke, {
      class: q([{ "root-item": !0, dark: e.colorScheme === "dark" }]),
      data: k.value,
      maxDepth: e.maxDepth,
      firstKey: !0,
